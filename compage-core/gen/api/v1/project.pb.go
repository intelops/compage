...
func (x *ProjectRequest) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
func (x *ProjectRequest) GetProjectName() string {
	if x != nil {
...
func (x *ProjectRequest) GetRepositoryName() string {
	if x != nil {
...
func (x *ProjectRequest) GetMetadata() string {
	if x != nil {
		return x.Metadata
	}
	return ""
...
var file_api_v1_project_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x22, 0xa6,
	...
	0x04, 0x79, 0x61, 0x6d, 0x6c, 0x12, 0x1a, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4e, 0x61, 0x6d,
	...
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x2f, 0x0a, 0x0f, 0x50, 0x72, 0x6f, 0x6a, 0x65,
	...
	,
	...
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6b, 0x75, 0x62, 0x65, 0x2d, 0x74, 0x61, 0x72, 0x69, 0x61,
	0x6e, 0x2f, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x67, 0x65, 0x2d, 0x63, 0x6f, 0x72, 0x65, 0x2f, 0x67,
...
var file_api_v1_project_proto_goTypes = []interface{}{
	(*ProjectRequest)(nil),  // 0: api.v1.ProjectRequest
	(*ProjectResponse)(nil), // 1: api.v1.ProjectResponse
}
var file_api_v1_project_proto_depIdxs = []int32{
	0, // 0: api.v1.ProjectService.CreateProject:input_type -> api.v1.ProjectRequest
	0, // 1: api.v1.ProjectService.UpdateProject:input_type -> api.v1.ProjectRequest
	1, // 2: api.v1.ProjectService.CreateProject:output_type -> api.v1.ProjectResponse
	1, // 3: api.v1.ProjectService.UpdateProject:output_type -> api.v1.ProjectResponse
